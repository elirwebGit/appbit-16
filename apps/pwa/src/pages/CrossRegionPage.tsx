...
import { analyzeQuestion, crossRegionAnalysis } from "../services/api";
...
export default function CrossRegionPage() {
  ...
  const lidarComConsulta = async (e: React.FormEvent) => {
    ...
    try {
      const response = await crossRegionAnalysis(
        "550c3cc0-8c5e-4ec0-9a89-2586b1751241",
        "81a9da91-59ca-47de-9da4-533e7d7ce058",
      );
      ...
      >
        ...
        <aside
          style={{
            ...
            gap: "20px",
            borderRight:
              isMobile || isLeftSidebarOpen ? "1px solid #334155" : "none",
        ...
        >
          ...
          >
            ...
            {/* ===== MAP ===== */}
            <div
              style={{ flex: 1, position: "relative", minWidth: 0, zIndex: 0 }}
            >
              <MapaVisent />
            </div>
            ...
            {(isMobile || (!isMobile && !isDesktopChatOpen)) && (
              <button
                ...
                style={{
                  ...
                  zIndex: 35,
                  transition:
                    "bottom 0.3s ease, transform 0.2s ease, box-shadow 0.2s ease",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "scale(1.1)";
                  e.currentTarget.style.boxShadow =
                    "0 6px 20px rgba(2, 132, 199, 0.6)";
                }}
                onMouseLeave={(e) => {
