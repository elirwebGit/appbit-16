...
| [ADR-002](./ADR-002-fastify.md) | Fastify como framework HTTP | ❌ Substituída por [ADR-007](./ADR-007-express.md) |
...
| [ADR-007](./ADR-007-express.md) | Express como framework HTTP | ✅ Aceita |
| [ADR-008](./ADR-008-pwa-offline-strategy.md) | Estratégia de PWA e Offline-First | ✅ Aceita |
